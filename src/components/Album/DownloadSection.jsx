                ...
                <Fragment key={linkId}>
                  ...
                  <div className='row mx-auto mb-3'>
                    <div className='col col-6 mx-auto py-2'>
                      <button target="_blank" className={classNames('btn btn-secondary', styles.download)} href={url}>{t('Download')}</button>
                    </div>
...
function DirectButton (props) {
  ...
  return (
      ...
      {!directUrl
        ...
        : <button target="_blank" className={classNames('btn btn-secondary', styles.download, styles.direct)} href={directUrl}>{t('Direct')}</button>}
    </>
  )
}
