...
function Star (props) {
  ...
  function saveRating () {
    client.mutate({ mutation: mutationRating, variables: { albumId, score: position + 1 } })
      .then(() => {
  ...
  const className = classNames(styles.star, fill, 'pe-1', { [styles.gold]: goldScore > position })
